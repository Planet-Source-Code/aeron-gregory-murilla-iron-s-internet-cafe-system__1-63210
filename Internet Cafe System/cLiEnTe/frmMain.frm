...
Object = "{E6BA3C62-D4BA-11D8-B0B3-DA6200B0AC60}#1.0#0"; "VolumeControl.ocx"
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picAbout 
      ...
      Begin VB.Label lblTitle 
         BackColor       =   &H00404040&
         BackStyle       =   0  'Transparent
         Caption         =   "PC Empire's Internet Cafe System             CLIENT APP"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   11.25
            Charset         =   0
   ...
   Begin ShockwaveFlashObjectsCtl.ShockwaveFlash Shock 
      ...
      _cy             =   13573
      FlashVars       =   ""
      Movie           =   "c:\new cafe\cliente\swf\bckgrnd.swf"
      Src             =   "c:\new cafe\cliente\swf\bckgrnd.swf"
      WMode           =   "Window"
      Play            =   -1  'True
      Loop            =   -1  'True
   ...
   Begin CLIENTE.SkinForm SkinnedForm 
      ...
      _ExtentY        =   1508
      MinimizeBtn     =   0   'False
      Caption         =   "Internet Cafe System Screen Lock                                                                     IrOnSoFt"
      CaptionTop      =   250
   End
   Begin VolControl.VolumeControl VolumeMaster 
      Left            =   3720
      Top             =   0
      _ExtentX        =   847
      _ExtentY        =   847
